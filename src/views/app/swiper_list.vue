<template>
	<div class="com-list-content">
		...
		<com-table ref="table" url="/admin/lunbo/list" :search="condition" v-slot="{data}" :search-com="$refs.search">
...
export default {
	...
	methods:{
		add(){
			this.$dialog('swiper_detail',{type:'add',data:{}},()=>{
				this.$refs.table.refresh(true);
			})
		},
		// edit(data){
		// 	this.$dialog('swiper_detail',{type:'edit',data:data},()=>{
		// 		this.$refs.table.refresh();
		// 	})
		// },
		remove(data){
			this.$axios.delete('/admin/lunbo/del?id='+data.id)
			.then(data=>{
				this.$refs.table.refresh();
			}).end();
		}
