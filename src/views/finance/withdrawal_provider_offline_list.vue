<template>
	<div class="com-list-content">
		...
		<com-table ref="table" url="/admin/balanceChangeRecord/listProviderPage?changeType=15" :search="condition" v-slot="{data}" :search-com="$refs.search" autolimitwidth>
...
export default {
	...
	methods:{
		add(){
			this.$dialog('withdrawal_provider_offline_detail',{type:'add',data:{}},()=>{
